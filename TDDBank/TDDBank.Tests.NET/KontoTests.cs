...
namespace TDDBank.Tests.NET
{
    public class UnitTest1
    {
        ...
        [Fact]
        public void Auszaheln_on_saturday_should_throw_InvalidOperationException()
        {
            var konto = new Konto();
            konto.Einzahlen(60);
            ...
            {
                // 2017-10-14 -> Saturday
                System.Fakes.ShimDateTime.NowGet = () => new DateTime(2017, 10, 14);
